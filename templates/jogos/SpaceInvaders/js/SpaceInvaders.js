...
const audioJogo = new Audio("./audio/justiceleague.mp3");
...
const audioTiros = () => {
  ...
  audioDoTiro.setAttribute("src", "./audio/tiro.mp3");
  audioDoTiro.play();
...
const naveInimigas = () => {
  ...
  inimigo.style.backgroundImage = "url(./img/inimigo.gif)";
...
const naveInimigaDestruida = (posicaoLeftNaveInimiga, posicaoTopNaveInimiga) => {
  ...
  naveInimigaDestruida.style.backgroundImage = "url(./img/eliminado.gif)";
...
const explosaoNaveInimigaDestruida = (posicaoLeftNaveInimiga) => {
  ...
  explosaoNaveInimiga.style.backgroundImage = "url(./img/explosao.gif)";
...
const audioExplosoes = () => {
  ...
  audioExplosaoNaveInimiga.setAttribute("src", "./audio/destruido.mp3");
...
const gameOver = () => {
  ...
  window.parent.postMessage({ gameOver: true, score: pontosAtual }, "*");
}
